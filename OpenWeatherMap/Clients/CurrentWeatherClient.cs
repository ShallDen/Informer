...
namespace OpenWeatherMap
{
    ...
    internal sealed class CurrentWeatherClient : ApiClientBase, ICurrentWeatherClient
    {
        ...
        public Task<CurrentWeatherResponse> GetByName(string cityName, MetricSystem metric = MetricSystem.Metric, OpenWeatherMapLanguage language = OpenWeatherMapLanguage.RU)
        {
